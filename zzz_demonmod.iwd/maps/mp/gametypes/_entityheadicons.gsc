...
init()
{
	...
	entityHeadIconHandler = maps\mp\gametypes\_perplayer::init( "entityheadiconhandler", ::showAllEntityHeadIcons, ::hideAllEntityHeadIcons );
...
{
	if( entity.entityHeadIconTeam != "none" && ( !isdefined( self.pers["team"] ) || self.pers["team"] != entity.entityHeadIconTeam ) )
		return;
	...
	headicon.alpha = .4;
	headicon setShader( game[ "hudicon_" + self.pers["team"] ], 10, 10 );
