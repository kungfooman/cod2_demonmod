...
changeTeam( team )
{
	...
	{
		self setClientCvar( "g_scriptMainMenu", game["menu_"+ self maps\mp\gametypes\_class::getClass() +"_allies"] );
		self openMenu( game["menu_"+ self maps\mp\gametypes\_class::getClass() +"_allies"] );
	}
	else
	{
		self setClientCvar( "g_scriptMainMenu", game["menu_"+ self maps\mp\gametypes\_class::getClass() +"_axis"] );
...
updateTeamChangeCvars()
{
	...
	if( !level.teamBased || level.maxclients < 2 )
	{
		joinallies = 1;
		joinaxis = 1;
	}
